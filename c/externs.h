...
extern void S_error_abort PROTO((const char *s)) __attribute__((noreturn));
extern void S_abnormal_exit PROTO((void)) __attribute__((noreturn));
...
extern void S_boot_error PROTO((const ptr who, ptr s, ptr args)) __attribute__((noreturn));
